/* Predict2U service worker v219 — fast core install, bounded caches,
   native-install support, exact push deep links and recoverable offline navigation. */
const VERSION='v219';
const CACHE_VERSION='predict2u-v219';
const APP_CACHE=CACHE_VERSION;
const RUNTIME_CACHE='predict2u-runtime-v219';
const IMAGE_CACHE='predict2u-images-v219';
