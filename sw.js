...
const VERSION='v245';
const CACHE_VERSION='predict2u-v245';
const APP_CACHE=CACHE_VERSION;
const RUNTIME_CACHE='predict2u-runtime-v245';
const IMAGE_CACHE='predict2u-images-v245';
...
const CORE_SHELL=[
  './','./index.html','./board.html','./bankers.html','./engines.html','./all-engines.html','./news.html','./community.html','./offline.html','./manifest.webmanifest',
