/* Predict2U service worker v217 — fast core install, bounded caches,
   native-install support, exact push deep links and recoverable offline navigation. */
const VERSION='v217';
const CACHE_VERSION='predict2u-v217';
const APP_CACHE=CACHE_VERSION;
const RUNTIME_CACHE='predict2u-runtime-v217';
const IMAGE_CACHE='predict2u-images-v217';
...
const CORE_SHELL=[
  ...
  './pwa-launch.js','./pwa-launch.css','./mobile-app-nav.js','./mobile-app-nav.css','./device-responsive-v207.css','./acca-mobile-v209.css','./mobile-polish-v211.css','./p2u-utilities-v217.css','./ui-foundation-v217.css','./ui-experience-v217.js','./slip.js',
