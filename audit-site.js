...
const report={generatedAt:new Date().toISOString(),auditVersion:"v160",cacheVersion:cacheMatch?cacheMatch[1]:null,engineCount,critical,warnings:uniqueWarnings,passedCount:passed.length};
