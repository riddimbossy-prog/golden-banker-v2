...
const required=[
  ...
  'push-notifications.js','push-notifications.css','news.js','news.css','predict2u-transfers.webp','predict2u-transfers-thumb.webp','SUPABASE_FOOTBALL_NEWS_v189.sql','football-assets.js','community-consistency.js','brand-performance.css','analytics.js','analytics.css','product-analytics.js','product-analytics.css','SUPABASE_ANALYTICS_v186.sql','SUPABASE_PUSH_SETUP_v183.sql','PUSH_NOTIFICATIONS_v183.md','VAPID_KEY_GENERATOR_v183.html','queue-push-events.js','push-event-snapshot.json','supabase/functions/p2u-push-dispatch/index.ts','supabase/functions/p2u-news-sync/index.ts','.github/workflows/news-sync.yml','learning-supervisor.js','engine-learning.js','engine-learning-selftest.js','engine-learning-admin.js','engine-learning-admin.css','engine-learning-ui.css','engine-learning-ledger.json','engine-learning-report.json','model-governance.js','governance-supervisor.js','model-governance-admin.js','model-governance-admin.css','model-governance-report.json','model-governance-audit.json','model-governance-selftest.js','model-intelligence-panels.js','engine-consensus.js','consensus-report.js','consensus-admin.js','consensus-admin.css','consensus-selftest.js','engine-consensus-report.json','match-context-intelligence.js','context-supervisor.js','context-report.js','context-admin.js','context-admin.css','context-selftest.js','match-context-report.json'
];
